...
check('details: one block per run with a log tail or notes, escaped; the summary keeps its click from the item', details, '<details data-run="r1"><summary onclick="event.stopPropagation()">r1 log</summary><pre>note looks fine &lt;b&gt;</pre></details>\n<details data-run="r2"><summary onclick="event.stopPropagation()">r2 log</summary><pre>00:00:01 Reading file docs/x.md\n00:00:02 Executing bash: ls</pre></details>')
