...
function js_table(regex) {
  ...
  return [
    ...
    '#item .js_table .label { display:block; height:100%; width:100%; max-width:300px; border-left: 4px solid #444; overflow:hidden; text-overflow: ellipsis; vertical-align: baseline; padding-left:10px; font-family:"jetbrains mono", monospace; font-size:90% }',
    ...
    '  #item .js_table .label { max-width:250px; } }',
