#chat defines utilities for _chat items_ that represent chat histories using _delimiter macros_. See #/gpt #/gemini #/claude #/groq #/ollama #/tiny #/gemma for agent-specific chat items.  
