...
let x = { 
  ...
  sleep_hours: [],
  sleep_lengths: [],
  // TODO: try allowing different 'kinds' of day, e.g. 'early' or 'late', determined at sleep time for the following day so it can affect next day's wake
  //       (resulting in a mixture model)
