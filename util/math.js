...
const addf = (xJ, yJ, f) => map2(xJ, yJ, (x, y) => x + f(y))
const sub = (xJ, yJ) => map2(xJ, yJ, (x, y) => x - y)
const subf = (xJ, yJ) => map2(xJ, yJ, (x, y) => x - f(y))
const mul = (xJ, yJ) => map2(xJ, yJ, (x, y) => x * y)
const mulf = (xJ, yJ, f) => map2(xJ, yJ, (x, y) => x * f(y))
const div = (xJ, yJ) => map2(xJ, yJ, (x, y) => x / y)
const divf = (xJ, yJ, f) => map2(xJ, yJ, (x, y) => x / f(y))
