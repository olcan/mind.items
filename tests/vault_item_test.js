...
check('review links with the root', vm.runInContext("vault_review_links('chat_a1', '/Users/olcan/vault')", ctx), '[chat_a1](vscode-insiders://olcan.auto-open-obsidian/review?worktree=chat_a1&root=%2FUsers%2Folcan%2Fvault) · [dir](vscode-insiders://olcan.auto-open-obsidian/open?worktree=chat_a1&root=%2FUsers%2Folcan%2Fvault)')
...
check('both links carry the root encoded (a space, a hash), the folder one through the extension too', vm.runInContext("vault_review_links('chat_a1', '/Users/o c/v#1')", ctx), '[chat_a1](vscode-insiders://olcan.auto-open-obsidian/review?worktree=chat_a1&root=%2FUsers%2Fo%20c%2Fv%231) · [dir](vscode-insiders://olcan.auto-open-obsidian/open?worktree=chat_a1&root=%2FUsers%2Fo%20c%2Fv%231)')
vm.runInContext("_this._global_store._bridge.root = '/Users/olcan/vault'", ctx)
check('the rows carry the links once the listing names the root', vm.runInContext("vault_proposal_rows(_this._global_store._bridge, {}, " + proposalLink + ")", ctx)[0][1], '[chat_a1](vscode-insiders://olcan.auto-open-obsidian/review?worktree=chat_a1&root=%2FUsers%2Folcan%2Fvault) · [dir](vscode-insiders://olcan.auto-open-obsidian/open?worktree=chat_a1&root=%2FUsers%2Folcan%2Fvault)')
