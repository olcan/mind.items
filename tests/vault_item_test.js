...
// the url builder behind the links (the one place for the scheme and the editor; the todoer's task rows reach it
// through this item's eval to link a marker): raw urls, escaped by the caller; none without a root or for a name
// outside the grammar
