...
// TODO: instead of above(x), which can be hard to pick or "get right", could you just "maximize"? can you define that intuitively based on "evolving relative domains"? you could probably require distance-based log_w since we need a sense of direction and progress in this case
//
