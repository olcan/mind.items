...
check('line pass: a rule line inside a raw html comment stays its text, no sentinel', (v => v == '<div class="vault-source"><pre class="vault-comment" style="white-space:pre-wrap;color:#6a737d"><code class="vault-comment">' + h._vault_grammar_refs('<!-- x\n---\n-->') + '</code></pre></div>' && !/&#[123];|<hr>/.test(v))(h._vault_source_view('<!-- x\n---\n-->\n')), true)
...
check('html: an inline comment after prose is a gray code element of references with the code chrome neutralized', h._vault_source_view('text <!-- note -->\n'), '<div class="vault-source"><p>text <code class="vault-comment" style="background:none;padding:0;border-radius:0;color:#6a737d">&#60;&#33;&#45;&#45; note &#45;&#45;&#62;</code></p></div>')
